        ...
        /*if (isMedia && !mek.message.videoMessage || isImage) {*/
          /*  const encmedia = mek
           ...
           case 'daftar':
                			...
                			if(isNaN(umurUser)) return await reply('Kalo nulis yang bener! -_- ')
                			...
                			if (umurUser < 12) return reply(`your age is too young minimum 12 years`)
                    			...
                    			await conn.sendMessage(from, ppimg, image, {quoted: mek, caption: `*[Terdaftar]*

\`\`\`Nama: ${namaUser}
No.    : wa.me/${sender.split("@")[0]}
Umur : ${umurUser}
Ns.     : 72nkG82hkwi920hapu\`\`\`
`})  			
                    			console.log(color('[MENDAFTAR]'), color(time, 'yellow'), 'Name:', color(namaUser, 'cyan'), 'Age:', color(umurUser, 'cyan'), 'Serial:', color("777", 'cyan'), 'in', color(sender || groupName))
                			} else {
                    			addRegisteredUser(sender, namaUser, umurUser, time)
                    			await conn.sendMessage(from, ppimg, image, {quoted: mek, caption: `*[Terdaftar]*
...
Ns.     : 72nkG82hkwi920hapu\`\`\`
`})
                    			console.log(color('[MENDAFTAR]'), color(time, 'yellow'), 'Name:', color(namaUser, 'cyan'), 'Age:', color(umurUser, 'cyan'), 'Serial:', color("7777", 'cyan'))
                			}
					break
