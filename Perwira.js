...
//KLIKk TOMBOL SUBSCRIBE !!!! https://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg
...
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/neon-devil-wings?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'neon':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/futuristic-technology?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'mascot':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/black-white-bear-mascot?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'beach':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/textpro/on-the-beach?teks=${q}&&background=0`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
...
case 'fire':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/flaming-fire?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'metalicgold':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/metalic-gold?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'sky':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/shadow-sky?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'cup':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/teks-cup?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'bluelove':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/romantic-messages?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'burn':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/burn-paper?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'cup2':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/funny-cup?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'lovemsg':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/love-messages?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'grass':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/under-grass?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'redlove':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/romantic-double?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break

case 'cup3':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/coffee-cup?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'woodlove':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wood-hearth?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'woodflower':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wooden-boards?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'wolfmetal':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wolf-metal?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'ocean':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/underwater?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'goldflower':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/golden-roses?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'woodenfall':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/under-fall?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'glowtext':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/neon-glow?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'yellowtext':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/3d-glowing?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'orangetext':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/vintage-text?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'honey':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/honey-text?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'nature':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/green-leaves?teks=${q}&&font=1`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'glowrainbow':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/glow-rainbow?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'stars':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/write-stars?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'fur':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/fur-effect?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'cromium':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/crisp-chrome?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'hellokitty':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/embroidery-text?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'glowrainbow2':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/3d-rainbow-bg?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'yellow3d':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/striking-3d?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'watermelon':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/summer-watermelon?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'matrix':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/under-web-matrix?teks=${q}&&background=2`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'material':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/multi-material?teks=${q}&&background=5`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'glowbutterfly':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/butter-fly?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'blackwood':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wooden-3d-black?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'multimetal':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/banner-metal?teks=${q}&&background=0`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'harrypotter':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/harry-poter?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'lightblue':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/neon-lights?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'coofe':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/put-coffee-cup?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'scary':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/text-on-scary?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'purplesmoke':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/smoke-typography?teks=${q}`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'partyneon':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/party-neon?teks=${q}&&background=3`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'multimetalic':
if (args.length < 1) return reply("Masukkan teksnya")
imagt = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/dark-metal?teks=${q}&&background=1`)
conn.sendMessage(from, imagt, image, {quoted: mek, caption: "_Sudah jadi kak_"})
break
case 'anime':
